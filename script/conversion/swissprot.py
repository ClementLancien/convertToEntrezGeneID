# -*- coding: utf-8 -*-
"""
Created on Thu Aug 24 17:29:58 2017
...
class Swissprot():
    ...
    def __init__(self):
        ...
        self.swissprot = config.get('Download', 'gene2swissprot')
        self.protein = config.get('Convert', 'Swissprot')        
    ...
    def get_Swissprot(self):
        ...
        try:
            ...
            with open(self.swissprot,'r') as inputFile,\
