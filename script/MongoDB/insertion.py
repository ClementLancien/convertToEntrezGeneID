...
if __name__ == '__main__':
    ...
    Insertion().insert.push_Ensembl_protein
    Insertion().insert.push_UniGene()
    Insertion().insert.push_GenBank_transcript()
    Insertion().insert.push_RefSeq_transcript()
    Insertion().insert.push_GenBank_protein()
    Insertion().insert.push_RefSeq_protein()
    Insertion().insert.push_GI_transcript()
    Insertion().insert.push_GI_protein()
    Insertion().insert.push_Info()
    Insertion().insert.push_GPL()
    Insertion().insert.push_Homologene()
    Insertion().insert.push_Vega_gene()
    Insertion().insert.push_Vega_transcript()
    Insertion().insert.push_Vega_protein()
    Insertion().insert.push_History()
    Insertion().insert.push_Swissprot()
    Insertion().insert.push_trEMBL()
